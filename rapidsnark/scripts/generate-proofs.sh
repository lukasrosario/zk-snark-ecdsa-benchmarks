...
hyperfine --min-runs 1 --max-runs 1 \
    ...
    '/rapidsnark/package_noasm/bin/prover /out/setup/circuit.zkey /out/witnesses/witness_{test_case}.wtns /out/proofs/proof_{test_case}.json /out/proofs/public_{test_case}.json'
